...
model = load_model('Alzheimer Detection new\AD_Model_Inception_V3_Custom.h5')
...
def plot_confusion_matrix(normalize):
  ...
  plt.savefig('Inception_V3_Confusion_Matrix_Custom.png')
  plt.show()
...
plt.savefig('Inception_V3_ct_accuracy_Custom.png')
plt.show()
...
plt.legend(['Training', 'Testing'])
plt.savefig('Inception_V3_dem_loss_Custom.png')
plt.show()